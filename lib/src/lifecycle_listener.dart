...
abstract class LifecycleListener {
  ...
  ///
  /// [context] bundles the step outcome (see [StepStatus], plus
  /// [StepFailure]/[StepAmbiguous] when additional error details are present)
  /// along with step timing and metadata, the shared [WidgetTesterWorld], and the
